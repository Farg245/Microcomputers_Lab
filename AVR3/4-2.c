...
#define SECOND_DIGIT '8'

#include <avr/io.h>
#include <util/delay.h>
#include <avr/interrupt.h>

#define state2_alarm_off 100
#define state3_alarm_off 170

#define state4_alarm_on_off 205
#define state5_alarm_on 400
#define state6_alarm_on 550
#define state7_alarm_on 800
#define state8_alarm_on 1023
